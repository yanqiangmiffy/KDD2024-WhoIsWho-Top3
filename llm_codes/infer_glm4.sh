...
accelerate launch --num_processes 8 inference_glm4.py --lora_path $lora_path --model_path $path_to_model --pub_path $path_to_pub_file --eval_path $path_to_eval_author --saved_dir $result_to_save --batch_size 1 --max_source_length 4096
